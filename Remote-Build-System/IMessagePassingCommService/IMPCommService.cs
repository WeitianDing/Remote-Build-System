...
namespace MessagePassingComm
{
    ...
    {
        public const string fileStorage = "../../../Mock Repository";
    ...
    {
        public const string fileStorage = "../../../BuildFileStore";
        public static string baseAddress { get; set; }
    }
    ...
    public interface IMessagePassingComm
    {
        ...
        [OperationContract]
        bool openFileForWrite(string name, string targetStorage);
    ...
    public class CommMessage
    {
        public enum MessageType
        {
            ...
            [EnumMember]
            ready,              //child builder response availability status to mother build 
            [EnumMember]
            working,            //child builder response working status to mother build
            [EnumMember]
            closeChild,        //close all child builders
            [EnumMember]
            closeMother         //close mother builder
        ...
        [DataMember]
        public Command driver { get; set; }
        [DataMember]
        public Command XML { get; set; }
